...
Route::post('/subtask/add/{task}', [TaskController::class,'addSubtask'])->name('subtask.add');
Route::get('/subtask/toggle/{id}', [TaskController::class,'toggleSubtask'])->name('subtask.toggle');
Route::post('/subtask/update/{id}', [TaskController::class, 'updateSubtask'])->name('subtask.update');
