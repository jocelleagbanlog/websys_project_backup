            ...
            <div class="flex items-center gap-2 w-full">
                ...
                <div class="relative flex-1 w-full">
                    ...
                    <input type="text"
                        ...
                        class="w-full px-4 py-2 pl-10 border rounded-lg shadow-sm focus:outline-none focus:border-transparent focus:ring-0 focus:shadow-[0_0_0_3px_rgba(60,141,188,0.25),0_0_0_6px_rgba(90,169,201,0.15)]">
                ...
                {{-- SEARCH BUTTON --}}
                <button type="submit"
                class="blue text-white px-5 py-2 rounded-lg shadow whitespace-nowrap">
                    Search
                </button>

                {{-- CLEAR BUTTON --}}
                <a href="{{ url()->current() }}"
                class="gray px-5 py-2 rounded-lg shadow whitespace-nowrap">
                    Clear
                </a>
